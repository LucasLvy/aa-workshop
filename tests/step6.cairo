...
use snforge_std::{
    start_prank, stop_prank, start_mock_call, stop_mock_call, start_spoof, stop_spoof,
};
...
fn handles_a_single_call() {
    ...
    let call = Call { to: call_address, selector: selector!("my_function"), calldata: array![], };
...
fn handles_multiple_calls() {
    ...
    let call_1 = Call {
        to: call_address_1, selector: selector!("my_function_1"), calldata: array![],
    };
    ...
    let call_2 = Call {
        to: call_address_2, selector: selector!("my_function_2"), calldata: array![],
    };
